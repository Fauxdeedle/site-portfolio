...
stats:
  ...
  - value: "-40%"
    label: Reduction in ID step abandonment
  - value: "6"
    label: Enterprise users
result: >-
  Strong launch reception with immediate interest from existing partners
  including Microsoft and Mercury Insurance, plus inbound requests from
  beauty and technology brands. Grew to 6 companies using the product
  across multiple internal divisions.
---
